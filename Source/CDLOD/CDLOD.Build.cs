...
public class CDLOD : ModuleRules
{
	public CDLOD(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        PublicDependencyModuleNames.AddRange(new string[] {"UnrealFastNoisePlugin" });
